    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseTwitterAuthentication(
               consumerKey: "xoEkew7goDzbvAQE55DRWumTa",
               consumerSecret: "yfkvUUpJa3RfvWEClBzir9lP7bVcnyihozZr1b2uLI0H5avWGF");

            app.UseFacebookAuthentication(
               appId: "507090926102585",
               appSecret: "4a3ef60d67cc1107502a6e3aa0994623");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "254798114782-0md660d3sa7fuah6p2q60ljs6d6mgoog.apps.googleusercontent.com",
                ClientSecret = "wJh6Zhte98zGhwF1L3n1FXyS"
            });
        }
    }
}